...
def displayHistory(self):
    try:
            ...
            # load excel file
            dfi = pd.read_excel("Demo/Data/pri_hd.xlsx", sheet_name="pri_hd")            
            dfi.to_sql(name='pri_hd', con=conn, if_exists='append')
            dfq = pd.read_excel("Demo/Data/prq_hd.xlsx", sheet_name="prq_hd")
            dfq.to_sql(name='prq_hd', con=conn, if_exists='append')
            dfq = pd.read_excel("Demo/Data/prw_hd.xlsx", sheet_name="prw_hd")
