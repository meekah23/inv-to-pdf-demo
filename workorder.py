...
def getData(self):
        try:
            ...
            #get headers
            cur.execute("SELECT OWDATE,OSLSMAN,ADDEDBY,OWNO,ORDATE FROM prw_hd")
            result = cur.fetchall()
            ...
            #get ship details
            cur.execute("SELECT ONAME||COALESCE(OFNAME,' '),OADDR1, OADDR2,OADDR3,OPCODE,OBPHONE,OPSTNO,OSTREET,OINAME,OIADDR1,OIADDR2,OIADDR3,OIPCODE FROM prw_hd")
...
def toPDF(self):
        ...
        try:
            ...
            for data, sumamt, ogst, ototal, odate, osale, oadd, owonum, ordate, oname, osadd1, osadd2, osadd3, oscode, osphone, ospstno, olstr, olname, oladd1, oladd2, oladd3, olcode in zip(all_data, amt, gst, total, date, saleman,addedby,wonum,datereq,name, sadd1, sadd2, sadd3, scode, sphone, spstno, lstreet, lname, ladd1, ladd2, ladd3, lcode):
                ...
                save_name = os.path.join("Demo/Demo Files/", "w"+ str(owonum)+'.pdf')           
            ...
            try:               
               ...
               df.to_excel('Demo/Data/prw_hd.xlsx',sheet_name = 'prw_hd', index=False)
