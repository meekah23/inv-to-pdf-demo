...
def getData(self):
        try:
            ...
            cur.execute("SELECT OQDATE,OSLSMAN,ADDEDBY,OQNO, OPONO, ORDATE FROM prq_hd")
            result = cur.fetchall()
            ...
            #get ship details
            cur.execute("SELECT ONAME||COALESCE(OFNAME,' '),OADDR1, OADDR2,OADDR3,OPCODE,OBPHONE,OPSTNO,OSTREET,OINAME,OIADDR1,OIADDR2,OIADDR3,OIPCODE FROM prq_hd")
...
def toPDF(self):
        ...
        try:
            ...
            for data, sumamt, ogst, ototal, odate, osale, oadd, oquo, opono,ordate,oname, osadd1, osadd2, osadd3, oscode, osphone, ospstno, olstr, olname, oladd1, oladd2, oladd3, olcode in zip(all_data, amt, gst, total, date, saleman,addedby,quote, po,datereq,name, sadd1, sadd2, sadd3, scode, sphone, spstno, lstreet, lname, ladd1, ladd2, ladd3, lcode):
                ...
                def header(canvas, pdf):
                    ...
                    # Draw heading
                     ...
                     tablelist1 = [["Date: "+str(odate),"Quote#: "+str(oquo)],
                                  ...
                                  ["GST#: "+str(gstnum),"Date Req: "+str(ordate)],
                ...
                save_name = os.path.join("Demo/Demo Files/", "q"+ str(oquo)+'.pdf')           
            ...
            try:               
               ...
               df.to_excel('Demo/Data/prq_hd.xlsx',sheet_name = 'prq_hd', index=False)
